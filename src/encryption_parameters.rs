...
pub struct EncryptionParameters {
    ...
    parms_id: ParmsID,
    use_special_prime_for_encryption: bool,
}
...
impl EncryptionParameters {
    ...
    /// Whether the encryption parameters are set to use a special prime for encryption.
    pub fn use_special_prime_for_encryption(&self) -> bool {
        self.use_special_prime_for_encryption
    }
    ...
    pub fn new(scheme: SchemeType) -> Self {
        let mut ret = EncryptionParameters {
            ...
            use_special_prime_for_encryption: false,
        };
    ...
    /// Set whether the encryption parameters use a special prime for encryption.
    pub fn set_use_special_prime_for_encryption(mut self, use_special_prime_for_encryption: bool) -> Self {
        self.use_special_prime_for_encryption = use_special_prime_for_encryption;
        self
    }
